...
describe("Books Page", () => {
  ...
  describe("getBorrowersForBook()", () => {
    it("should return an array for a book of all borrowers with their information and return status", () => {
      const books = booksFixture[3];
      const [first, second] = getBorrowersForBook(books, accounts);
    ...
    it("should limit the list to ten borrowers", () => {
      const books = booksFixture[1];
      const actual = getBorrowersForBook(books, accounts);
